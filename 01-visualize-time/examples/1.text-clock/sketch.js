...
function draw() {
  ...
  // if do not translate, y-axis needs to be incremented. 
	fill(200)
  ...
  push() // save the state of the canvas (including font & transformation settings)
    ...
    fill('#cc0000')
    text(now.year, -x, top)
    translate(0, spacing)//when you translate, the y-axis starts from 30

    fill('#992200')
    text(now.month, -x, top)//because y-axis starts from 30, current y is at 60
    translate(0, spacing)
