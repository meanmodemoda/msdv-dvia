...
function draw() {
  // Set the background to black (and clear the screen in the process) the most important thing is cleaning the background to achieve the effect
  background(0)
