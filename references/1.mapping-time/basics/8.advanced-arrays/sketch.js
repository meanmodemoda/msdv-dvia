function setup() {
  ...
  for (var i=0; i<width; i++){
    var amount = map(i, 0, width, 0, PI); // map `i` (0 to 720) to `amount` (0 to PI) //https://p5js.org/reference/#/p5/map
    var cosVal = abs(cos(amount)); // get the cosine (-1 to 1) of the amount and assign its absolute value (0 to 1) to the array //this is getting the gradience of the colorway
