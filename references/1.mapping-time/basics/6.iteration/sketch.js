...
function setup() {
  ...
  translate(100, 50)//translate is like reset x,y for easy referencing, so the following code can be 0,0
  fill('red')
  circle(0, 0, radius)
  ...
  translate(200, 0)//reset coordinates again
  fill('orange')
  for (var i=0; i<6; i++){
  ...
  xPositions.forEach(function(x, i){
    stroke(255 - 30*i)//gradient effect
    line(x, 0, x, 100)
  })
